...
public class SongUploads {
    public String songsCategory, songTitle, artist, imgSongUpload, songDuration,songLink, mkey;

    public SongUploads(String songsCategory, String songTitle, String artist, String imgSongUpload, String songDuration, String songLink) {
